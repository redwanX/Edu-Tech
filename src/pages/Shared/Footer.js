...
const Footer = () => {
  return (
    ...
    <div>
        <MdOutlineCastForEducation className='text-3xl'></MdOutlineCastForEducation>
    ...
    <p className="font-bold">
      ...
      <div className="grid grid-flow-col gap-4">
        <RiVisaFill className='text-2xl font-bold'></RiVisaFill>
        <RiMastercardFill  className='text-2xl font-bold'></RiMastercardFill>
      </div>
    </div>
  </footer>
  )
